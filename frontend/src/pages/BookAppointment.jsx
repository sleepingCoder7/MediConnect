...
const BookAppointment = () => {
    ...
    const inputClass = "w-full p-2 mb-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent cursor-pointer";
    ...
    return (
        ...
        <main className='flex justify-center p-6 w-full'>
            <form className='bg-white p-6 rounded shadow-md w-full md:w-[480px] flex flex-col h-fit md:mt-10' onSubmit={handleSubmit}>
                ...
                <input type="text" id="phone" name="phone" maxLength={10} placeholder="Enter your phone number" required value={formValues.phone} onChange={handleChange} className={inputClass}/>
